...
risk_scorer.py. This module is not wired into the live /predict flow
yet (DEV-001 is foundation only) -- see app/ml/train_model.py and
app/ml/predictor.py for how it's used.
